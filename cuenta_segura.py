class CuentaSegura:
    ...
    def saldo(self,valor):
        """setter para asignar saldo solo si es un numero no negativo"""
    ...
    def mostrar_historial(self):
        """Metodo publico que abstrae el detalle de como se guarda el historial"""
        print("Historial de transacciones:"," , ".join(self._historial))


cuenta=CuentaSegura("Isabela", 100)
